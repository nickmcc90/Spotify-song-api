...
function Updates() {
  return (
    <>
      {/* Keeping everything within a width of 85% of the screen with this div.  */}
      <div id='Updates' className='flex items-center w-[85%] mx-auto h-[300px] justify-center gap-7'>
        <i className="fa-solid fa-microchip text-2xl sm:text-3xl text-green-500"></i>
        {/* I sandwich this div between two microchip image icons. The <i> tags surrounding this */}
